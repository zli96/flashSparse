...
class dataSet_fp16(torch.nn.Module):
    ...
    def init_edges(self, partSize, window, wide):
        ...
        # if window==16:
        #     print((self.column_index.shape[0]/8)*(self.num_features/16))
        # else:
        #     print((self.column_index.shape[0]/8)*(self.num_features/8))
...
# fp16 + balance
class dataSet_fp16_balance(torch.nn.Module):

    def __init__(self, data, dimN, partsize, data_path, window, wide):
        super(dataSet_fp16_balance, self).__init__()
    ...
    def init_edges(self, partSize, window, wide):
        ...
        self.t_atomicTensor = FS_Block.blockProcess_fp16_balance(self.row_pointers, self.column_index, self.degrees, window, wide, partSize)
