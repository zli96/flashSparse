...
class MGCN_dataset_m32_gat(torch.nn.Module):
    ...
    def m_block_8_16_mr(self, data, dimN): 
        ...
        self.graph = np.load('/home/shijinliang/module/Libra/dgl_dataset/block/' + data +'-tf32-8-16-mr.npz')
        self.num_nodes_ori = self.graph['num_nodes_ori']-0
        self.num_nodes = self.graph['num_nodes']-0
        self.num_edges = self.graph['num_edges']-0
    ...
    def m_block_8_16_r(self, data, dimN): 
        self.graph = np.load('/home/shijinliang/module/Libra/dgl_dataset/block/' + data +'-tf32-8-16-r.npz')
        self.num_nodes_ori = self.graph['num_nodes_ori']-0
        self.num_nodes = self.graph['num_nodes']-0
        self.num_edges = self.graph['num_edges']-0
        ...
        self.degrees = torch.tensor(self.graph['degrees'])
        self.val = [1] * self.num_edges
        self.x= torch.ones(self.num_nodes_ori, dimN)
        result = self.row_pointers[2::2] - self.row_pointers[:-2:2]
        self.max=max(result)

    def m_block_16_8_r(self, data, dimN): 
        self.graph = np.load('/home/shijinliang/module/Libra/dgl_dataset/block/' + data +'-tf32-16-8-r.npz')
        self.num_nodes_ori = self.graph['num_nodes_ori']-0
        self.num_nodes = self.graph['num_nodes']-0
        self.num_edges = self.graph['num_edges']-0
    ...
    def m_block_16_8_mr(self, data, dimN): 
        self.graph = np.load('/home/shijinliang/module/Libra/dgl_dataset/block/' + data +'-tf32-16-8-mr.npz')
        self.num_nodes_ori = self.graph['num_nodes_ori']-0
        self.num_nodes = self.graph['num_nodes']-0
        self.num_edges = self.graph['num_edges']-0
...
class MGCN_dataset_m16_gat(torch.nn.Module):
    ...
    def m_block_8_16_mr(self, data, dimN): 
        self.graph = np.load('/home/shijinliang/module/Libra/dgl_dataset/block/' + data +'-fp16-8-16-mr.npz')
        self.num_nodes_ori = self.graph['num_nodes_ori']-0
        self.num_nodes = self.graph['num_nodes']-0
        self.num_edges = self.graph['num_edges']-0
    ...
    def m_block_8_16_r(self, data, dimN): 
        self.graph = np.load('/home/shijinliang/module/Libra/dgl_dataset/block/' + data +'-fp16-8-16-r.npz')
        self.num_nodes_ori = self.graph['num_nodes_ori']-0
        self.num_nodes = self.graph['num_nodes']-0
        self.num_edges = self.graph['num_edges']-0
    ...
    def m_block_16_8_mr(self, data, dimN): 
        self.graph = np.load('/home/shijinliang/module/Libra/dgl_dataset/block/' + data +'-fp16-16-8-mr.npz')
        self.num_nodes_ori = self.graph['num_nodes_ori']-0
        self.num_nodes = self.graph['num_nodes']-0
        self.num_edges = self.graph['num_edges']-0
    ...
    def m_block_16_8_r(self, data, dimN): 
        self.graph = np.load('/home/shijinliang/module/Libra/dgl_dataset/block/' + data +'-fp16-16-8-r.npz')
        self.num_nodes_ori = self.graph['num_nodes_ori']-0
        self.num_nodes = self.graph['num_nodes']-0
        self.num_edges = self.graph['num_edges']-0
