...
for index, row in data_df.iterrows():
    ...
    #N is 128, 192 = 16*8+8*8
    compute_16 = (inputInfo_16.row_pointers[-1].item()/8) * 2 * 192 * 2 
    
    #8x1
    inputInfo_8 = dataSet_fp16(data_path, 8, 8)
    compute_8 = (inputInfo_8.row_pointers[-1].item()/8) * 192 * 2 
