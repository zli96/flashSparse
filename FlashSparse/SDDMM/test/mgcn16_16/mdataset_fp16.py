...
class MGCN_dataset(torch.nn.Module):
    ...
    def init_edges(self):
        ...
        self.row_pointers, self.column_index, self.degrees, self.t_window_rowTensor=FS_Block.blockProcess_sddmm_balance(self.row_pointers1, self.column_index1, 16, 8, 32)
