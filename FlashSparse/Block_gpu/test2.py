...
df = pd.read_csv('/home/shijinliang/module/git-flashsprase-ae/dataset/data_filter.csv')
for index, row in df.iterrows():
            
    graph = np.load('/home/shijinliang/module/mnt/libra_suite/sp_matrix/' +  row.iloc[0] + '.npz')
